...
# Inicialização do Jboss. A opção -b 0.0.0.0 libera acesso à interface administrativa do EasyLifeNetworks para qualquer IP.
...
su - EasyLifeNetworks -c "cd /usr/share/EasyLifeNetworks/core;java -cp APController.jar loader.JLoader 127.0.0.1 5000 &> /dev/null &"
