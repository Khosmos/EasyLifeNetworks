...
ipa-server-install --realm=WIFI.UFF.BR  --domain=$DOMAIN --ds-password=$FIDMPASSWD --admin-password=$FIADMPASSWD --mkhomedir --ip-address=$INTIP --hostname="$MACHINE.$DOMAINWIFI" --idstart=10000 -U --setup-dns --forwarder=$DNSSERVER
#Firewall setup
